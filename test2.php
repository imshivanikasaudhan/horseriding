                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="account.php"><span
                                    class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home<span
                                    class="sr-only">(current)</span></a></li>
                        <li ><a href="test.php"><span
                                    class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Adhar Card<span
                                    class="sr-only">(current)</span></a></li>
        ...
        <div class="container" style="background: #fff; padding: 20px 40px; border-radius: 10px; width: 40rem;">
            ...
            <div class="card">
                <form>
                    ...
                    <input type="text" class="form-control" style="margin-top:10px;" placeholder="Enter Adhar No. ">
                    ...
                    <input type="file" class="custom-file-input" name="image">
                    <input type="text" class="form-control" style="margin-top:10px;" placeholder="Enter Pan No. ">
